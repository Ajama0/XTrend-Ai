...
//    }
//
//    public String getVideoByNewsId(Long id) {
//        VideoContent findVideo = videoContentRepository.findAll()
//                .stream()
//                .filter(videoContent -> videoContent.getNews().getId().equals(id))
//                .findFirst()
//                .orElseThrow(()->new RuntimeException("video record was not found"));
//
//
//        String videoUrl = findVideo.getVideo_url();
//
//        return videoUrl;
//    }
//}
